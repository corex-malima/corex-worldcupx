...
export function RankingFilters({ areas, classifications, areaValue, classificationValue, onAreaChange, onClassificationChange }: Props) {
  const selectClass = "min-h-11 rounded-2xl border border-corex-ink/10 bg-pitch-900 px-4 text-sm font-bold text-corex-ink outline-none";
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-corex-ink/10 bg-pitch-900 p-4">
      <Filter size={18} className="text-corex-ink/45" />
