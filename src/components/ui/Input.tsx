  ...
  return (
    <label className="block space-y-2">
      ...
      <span className="relative block">
        ...
        <input
          className={`min-h-12 w-full rounded-xl border border-white/10 bg-pitch-800 px-4 py-3 text-white outline-none transition placeholder:text-white/35 focus:border-cup-blue focus:ring-2 focus:ring-cup-blue/20 ${icon ? 'pl-11' : ''} ${className}`}
          {...props}
        />
      </span>
