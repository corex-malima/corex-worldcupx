  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-4 lg:grid-cols-[1.4fr_.6fr]">
        ...
        <Card>
          <p className="text-xs font-black uppercase tracking-widest text-corex-ink/45">Resumen</p>
          <div className="mt-4 grid grid-cols-2 gap-3 text-center">
            <div className="rounded-2xl bg-pitch-800 p-4"><TicketIcon className="mx-auto text-cup-blue" /><p className="mt-2 text-3xl font-black">{tickets.length}</p><p className="text-xs text-corex-ink/45">Total</p></div>
            <div className="rounded-2xl bg-pitch-800 p-4"><Trophy className="mx-auto text-cup-green" /><p className="mt-2 text-3xl font-black">{claimed}</p><p className="text-xs text-corex-ink/45">Activos</p></div>
