...
begin
    ...
    -- Eliminatorias: el marcador SÓLO cuenta cuando el cruce es exacto (mismos 2 equipos,
    -- sin importar local/visitante). Esto es lo que dice el doc oficial de puntaje.
    insert into public.score_details (ticket_id, category, item_ref, points, detail)
    ...
    -- exact_count y result_count: grupos + knockouts CON cruce exacto.
    with valid_pairs as (
